<x-guest-layout>
    <x-authentication-card>
        <x-slot name="logo">
            <img src="{{ asset('images/logo-estacionamiento.png') }}" alt="Estacionamiento Moreno" class="mx-auto object-contain"
                 style="width: 12rem; height: 9rem; max-width: 12rem; max-height: 9rem;">
        </x-slot>
